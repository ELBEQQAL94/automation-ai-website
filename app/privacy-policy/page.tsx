    ...
    <main className="flex w-full max-w-3xl flex-col gap-6 px-6 py-16 sm:py-24 lg:px-12">
      ...
      <div className="rounded-2xl border border-outline-variant/30 bg-surface-container-low p-6">
        <p className="text-base leading-7 text-on-surface-variant">
          ...
          reviewed privacy policy. Replace this content before relying on it or advertising it
          to visitors.
        </p>
      </div>

      <p className="text-lg leading-8 text-on-surface-variant">
        Automatoro (&quot;we&quot;, &quot;us&quot;) provides automation services. This page will
        describe what information we collect when you use this site or engage our services, how
        that information is used, and the choices you have around it.
      </p>
